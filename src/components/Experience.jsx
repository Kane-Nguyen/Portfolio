...
const Experience = () => {
  return (
    ...
    >
       <p className={styles.sectionSubText}>Tôi đã làm gì trong thời gian qua</p>
    <h2 className={styles.sectionHeadText}>Kinh nghiệm làm việc</h2>
    </motion.div>
    <div className="mt-20 flex flex-col">
      <VerticalTimeline>
        {experiences.map((experience , index) =>( <ExperienceCard key={index} experience={experience} {...experience} />)
